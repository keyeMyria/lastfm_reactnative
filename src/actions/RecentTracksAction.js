...
const recentTracksApi1 = "/2.0/?method=user.getrecenttracks&user=";
const recentTracksApi2 =
  "&api_key=5dc76e8a7e2d376900c7d1f0911439ac&format=json";
...
export const getRecentTracks = user => {
  return dispatch => {
    ...
    Axios.get(baseurl + recentTracksApi1 + user + recentTracksApi2)
      .then(response => {
        dispatch({
